(function () {
  ...
  let rotatingTextArray = ["Software Developer.", "Educator.", "Sci-Fi Lover."];
  ...
  rotatingTextStyleElement.innerHTML =
    getRotatingTextStyleString(rotatingTextArray);
  document.querySelector("head").append(rotatingTextStyleElement);
  rotatingTextCycleDuration &&
    (rotatingTextOverlay.style.animation = `rotatingText ${
      rotatingTextCycleDuration * rotatingTextArray.length
    }s infinite ease-out`);
